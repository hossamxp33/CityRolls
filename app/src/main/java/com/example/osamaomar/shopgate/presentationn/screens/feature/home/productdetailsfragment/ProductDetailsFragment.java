...
public class ProductDetailsFragment extends Fragment {
    ...
    FrameLayout loading;
    public TextView product_name, description, price, ratecount,amount,addtocart;
    RatingBar ratingBar;
...
//                ZGallery.with(getActivity(), images)
...
//                .show()
    ...
    private void setDataToViews(ProductDetails.ProductdetailsBean productdetailsBean) {
        ...
        productSizesAdapter = new ProductSizesAdapter(getActivity(), productdetailsBean.getProductsizes(), this);
        ...
        if (productdetailsBean.getTotal_rating() != null) {
            if (productdetailsBean.getTotal_rating().size() > 0) {
                ...
                ratingBar.setRating(productdetailsBean.getTotal_rating().get(0).getCount() /
                        productdetailsBean.getTotal_rating().get(0).getStars());
            }
        }

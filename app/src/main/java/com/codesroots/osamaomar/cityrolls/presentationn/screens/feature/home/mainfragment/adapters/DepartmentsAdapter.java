...
import com.codesroots.osamaomar.cityrolls.presentationn.screens.feature.smallstore.smallStoreFramgent;

import java.util.List;

import static com.codesroots.osamaomar.cityrolls.entities.names.CAT_ID;
import static com.codesroots.osamaomar.cityrolls.entities.names.CAT_NAME;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder,final int position) {
     //   Glide.with(context).load(categories.get(position).getPhoto()).dontAnimate().placeholder(R.drawable.dept1).into(holder.Image);
        ...
        holder.mView.setOnClickListener(v ->
                ...
                replace(R.id.main_frame_a, sucCates_fragment).addToBackStack(null).commit());
//        else
//        {
